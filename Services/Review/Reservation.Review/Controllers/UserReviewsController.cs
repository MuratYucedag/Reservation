...
namespace Reservation.Review.Controllers
{
    ...
    public class UserReviewsController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateUserReview(CreateUserReviwDto createUserReviwDto)
        {
            await _userReviewService.CreateUserReviewAsync(createUserReviwDto);
